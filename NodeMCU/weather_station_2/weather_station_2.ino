...
void loop() {
  if (!Ping.ping(remote_ip)) {
    ...
    if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 1500 || sendDataPrevMillis == 0)) {
      ...
      //aqi
      if (Firebase.RTDB.setInt(&fbdo, "station2/aqi2", aqi)) {
      ...
      //temperature
      if (Firebase.RTDB.setFloat(&fbdo, "station2/temp2", temperature)) {
        Serial.println("PASSED");
        Serial.println("PATH: " + fbdo.dataPath());
        Serial.println("TYPE: " + fbdo.dataType());
      }
      ...
      //humidity
      if (Firebase.RTDB.setFloat(&fbdo, "station2/humidity2", humidity)) {
        Serial.println("PASSED");
        Serial.println("PATH: " + fbdo.dataPath());
        Serial.println("TYPE: " + fbdo.dataType());
      }
